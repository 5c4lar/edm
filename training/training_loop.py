...
def training_loop(
    ...
    num_samples=50000,  # Number of images to calculate FID
):
    # Initialize.
    ...
    dist.print0(f"Dataset Mean: {network_kwargs['data_mean']}")
    dist.print0(f"Dataset Std: {network_kwargs['data_std']}")
    dist.print0()
    ...
    while True:
        ...
        if (
            ...
            fid = eval.calc(output_dir, ref_path, num_samples, 0, batch_gpu)
